    ...
    <v-row v-if="serial.connected" dense class="pa-4">
      ...
      <v-col cols="12" md="6">
        <v-card rounded="lg" variant="outlined">
          ...
          <v-card-text>
              <v-tabs v-model="elrsTab" density="compact" class="mb-3">
                <v-tab value="overview" prepend-icon="mdi-view-dashboard">概览</v-tab>
                <v-tab value="fields" prepend-icon="mdi-file-tree">字段树</v-tab>
              </v-tabs>

              <v-window v-model="elrsTab">
                ...
                <v-window-item value="fields">
                  ...
                  <template v-else>
                    ...
                    <div class="d-flex flex-wrap align-center ga-2 mb-3">
                      <v-btn size="small" variant="text" prepend-icon="mdi-home" @click="elrsGoRoot">
                        根目录
                      </v-btn>
                      <v-btn
                        size="small"
                    ...
                    <template v-else>
                      <v-sheet
                        ...
                        rounded="lg"
                        border
                        class="pa-3 mb-2 elrs-field-item"
                      >
                          ...
                          <template v-if="field.type === 11">
                            <div class="d-flex align-center ga-2">
                              <v-btn
                                ...
                                @click="elrsEnterFolder(field.id)"
                              >
                                进入文件夹
                              </v-btn>
...
// ========== ELRS 射频配置 ==========
const elrsTab           = ref<'overview' | 'fields'>('overview')
...
function elrsFieldIcon(field: { id: number; type: number }): string {
